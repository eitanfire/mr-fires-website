...
export const fallCourses: CourseData[] = [
  {
    ...
    currentWarmUpURL:
      "https://docs.google.com/document/d/1mXqeZbpJkEu5bMN7IXKqkxH5JQvsCB8BU_IgepkHCY8/edit?tab=t.0#bookmark=id.j55tuh7uvn8y",
  ...
  {
    id: 3,
    icon: "src/app/img/icons/python-icon.png",
  ...
  {
    id: 4,
    icon: "src/app/img/icons/java-icon.png",
